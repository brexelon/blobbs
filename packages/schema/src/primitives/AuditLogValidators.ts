...
export const AuditLogActionTypeSchema = withOpenApiType(
	createInt32EnumType(
		[
			...
			[AuditLogActionType.THREAD_CREATE, 'THREAD_CREATE', 'Thread was created'],
			[AuditLogActionType.THREAD_UPDATE, 'THREAD_UPDATE', 'Thread was updated'],
			[AuditLogActionType.THREAD_DELETE, 'THREAD_DELETE', 'Thread was deleted'],
		],

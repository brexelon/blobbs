...
/**
 * Allocates discriminators for application (bot) users.
 *
 * Regular users are unique by username alone and always carry discriminator 0; only
 * bots go through here, so several applications can share a base name without taking
 * that name out of the human namespace.
 */
